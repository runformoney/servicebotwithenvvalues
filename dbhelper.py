...
class DBHelper:
    def __init__(self):
        ...
        #db = MySQLdb.connect(host="172.30.115.81", port=3306, user="userRTL", passwd="eNU1gYbC1EYLe6gN", db="sampledb") ServiceBotTheMeanSquares.mysql-persistent-wxkt5-8gxd8.svc.cluster.local"
        db = MySQLdb.connect(host="ServiceBotTheMeanSquares.mysql-persistent-wxkt5-8gxd8.svc.cluster.local", port=3306, user="user85G", passwd="NQsbUwI6Mb10faeY", db="sampledb")
        conn = db.cursor()
